...
export const Route = createFileRoute("/messages")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Direct message inbox for mentors, organizations, and group members.",
      },
...
const conversations: Convo[] = [
  {
    ...
    name: "Marcus Johnson",
    role: "Mentor",
    body: "Great job on your progress! Let's schedule a time to talk about your next steps.",
    time: "9:30 AM",
    unread: 2,
    initial: "M",
    color: "purple",
  ...
  {
    id: "2",
    name: "TechForward Careers",
    role: "Organization",
    body: "Thanks for your interest! We'd love to learn more about your experience.",
    time: "Yesterday",
    unread: 1,
    initial: "T",
    color: "blue",
  },
  {
    ...
    role: "Group",
    body: "Aisha: Don't forget about our meeting this Saturday at 10 AM!",
    time: "Yesterday",
    unread: 4,
    initial: "Y",
    color: "teal",
  },
  {
    ...
    name: "Aisha Patel",
    role: "Friend",
    body: "Hey! I found a great workshop you might like.",
    time: "May 20",
    starred: true,
    initial: "A",
    color: "purple",
  ...
  {
    id: "5",
    name: "GreenPath Organization",
    role: "Organization",
    body: "We've updated the volunteer opportunities. Check them out!",
    time: "May 19",
    initial: "G",
    color: "blue",
  },
...
const thread = [
  {
    from: "them",
    time: "9:14 AM",
    body: "Hey Jayden — checked your reflection notes from the resource fair. Really thoughtful work.",
  },
  {
    from: "them",
    time: "9:15 AM",
    body: "I'd love to hear how the conversation with Bright Futures went.",
  },
  {
    from: "me",
    time: "9:22 AM",
    body: "Thanks! It went well — they're interested in the outreach role and want a follow-up.",
  },
  {
    from: "them",
    time: "9:30 AM",
      ...
      <div className="grid h-[680px] gap-5 rounded-3xl lg:grid-cols-[360px_1fr]">
        ...
        <aside className="flex flex-col overflow-hidden rounded-3xl border border-border/60 bg-surface">
          <div className="border-b border-border/60 p-4">
            ...
            <div className="mt-3 flex gap-2 overflow-x-auto">
              {filters.map((f, i) => (
                ...
                >
                  {f === "Unread" && (
                    <span className="mr-1 inline-block h-1.5 w-1.5 rounded-full bg-brand-teal" />
                  )}
                  {f}
                </button>
              ))}
          ...
          <div className="flex-1 overflow-y-auto">
            {conversations.map((c) => (
              ...
              >
                <span
                  className={`grid h-11 w-11 flex-shrink-0 place-items-center rounded-full text-sm font-bold text-white ${colorBg(c.color)}`}
                >
                  {c.initial}
                </span>
                <div className="min-w-0 flex-1">
                  <div className="flex items-baseline justify-between gap-2">
                    <div className="flex min-w-0 items-center gap-1.5">
                      ...
                      {c.starred && (
                        <Star className="h-3 w-3 flex-shrink-0 fill-brand-teal text-brand-teal" />
                      )}
                    </div>
        ...
        <section className="flex flex-col overflow-hidden rounded-3xl border border-border/60 bg-surface">
          <header className="flex items-center gap-3 border-b border-border/60 p-4">
            <span
              className={`grid h-11 w-11 place-items-center rounded-full text-sm font-bold text-white ${colorBg(current.color)}`}
            >
              {current.initial}
            </span>
